...
Furthermore, a large volume of multiwavelength data is already available from wide-field photometric surveys [e.g., SDSS, @York_etal2000; and Pan-STARRS, @Chambers_etal2016], all-sky photometric surveys [e.g., Gaia, @GaiaCollaboration2020; 2MASS, @Skrutskie_etal2006; and WISE, @Cutri_etal2013], targeted spectroscopic programs [e.g., SpeX Prism Library, @Burgasser2014], and both large [e.g., LAMOST, @Luo_etal2015; and APOGEE, @SDSS-DR17] and all-sky [SPHEREx, @Dore_etal2014] spectroscopic surveys.
